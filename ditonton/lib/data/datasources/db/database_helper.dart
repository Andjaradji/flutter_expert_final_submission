...
class DatabaseHelper {
  ...
  Future<int> insertMovieWatchlist(WatchlistModel movie) async {
    final db = await database;
    return await db!.insert(_tblMovieWatchlist, movie.toJson());
  }

  Future<int> insertTvSeriesWatchlist(WatchlistModel tv) async {
    final db = await database;
    return await db!.insert(_tblTvSeriesWatchlist, tv.toJson());
  }

  Future<int> removeMovieWatchlist(WatchlistModel movie) async {
    final db = await database;
  ...
  Future<int> removeTvSeriesWatchlist(WatchlistModel tv) async {
    final db = await database;
    return await db!.delete(
