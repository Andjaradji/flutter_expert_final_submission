...
void main() {
  ...
  final tTvModel = TvModel(
    ...
    id: 93405,
    originalName: '오징어 게임',
    overview: 'Hundreds of cash-strapped players accept a strange invitation to compete in childrens games—with high stakes. But, a tempting prize awaits the victor.',
    popularity: 2810.088,
    posterPath: '/dDlEmu3EZ0Pgg93K2SVNLCjCSvE.jpg',
    firstAirDate: '2021-10-29',
    name: 'Squid Game',
    voteAverage: 7.8,
    voteCount: 8632,
  );
  ...
  group('On Air Tv Series', () {
    ...
    test(
        'should return connection failure when the device is not connected to internet',
          ...
          // arrange
          when(mockRemoteDataSource.getOnAirTvShows())
              .thenThrow(SocketException('Failed to Connect to the Server'));
          // act
          final result = await repository.getOnTheAirTvShows();
          // assert
          verify(mockRemoteDataSource.getOnAirTvShows());
          expect(result,
              equals(Left(ConnectionFailure('Failed to Connect to the Server'))));
        });
  });
  ...
  group('Popular Tv Series', () {
    ...
    test(
        'should return connection failure when device is not connected to the internet',
          ...
          // assert
          expect(
              result, Left(ConnectionFailure('Failed to Connect to the Server')));
        });
  });
